...
export class Background {
    ...
    createLayer1() {
        ...
        this.layer1[383] = new Hitbox(4251,-4789,87,819 )
        this.layer1[384] = new Hitbox(3327,-4789,1011,93 )
        this.layer1[385] = new Hitbox(3327,-5755,61,1059 )
        this.layer1[386] = new Hitbox(1657,-5755,1731,79 )
        this.layer1[387] = new Hitbox(3527,-4728,93,491 )
        this.layer1[388] = new Hitbox(1797,-4328,1823,91 )
        this.layer1[389] = new Hitbox(3367,-5503,1381,87 )
        this.layer1[390] = new Hitbox(2718,-5703,83,397 )
        this.layer1[391] = new Hitbox(1078,-5376,1677,71 )
        this.layer1[392] = new Hitbox(1664,-6401,81,703 )
        this.layer1[393] = new Hitbox(1078,-5766,61,412 )
        this.layer1[394] = new Hitbox(96,-5766,990,51 )
        this.layer1[395] = new Hitbox(96,-6561,73,846 )
        this.layer1[396] = new Hitbox(1574,-5341,63,1243 )
        this.layer1[397] = new Hitbox(515,-5736,59,310 )
        this.layer1[398] = new Hitbox(-811,-5489,1334,63 )
        this.layer1[399] = new Hitbox(857,-6140,71,383 )
        this.layer1[400] = new Hitbox(857,-6140,235,75 )
        this.layer1[401] = new Hitbox(1017,-6681,75,612 )
        this.layer1[402] = new Hitbox(4289,-4565,957,73 )
        this.layer1[403] = new Hitbox(5175,-5521,71,1026 )
        this.layer1[404] = new Hitbox(-808,-5756,55,292 )
        this.layer1[405] = new Hitbox(-2000,-5756,1199,61 )
        this.layer1[406] = new Hitbox(-2000,-6518,63,823 )
        this.layer1[407] = new Hitbox(-4266,-6518,2329,68 )
        this.layer1[408] = new Hitbox(-4266,-6479,78,244 )
        this.layer1[409] = new Hitbox(-5093,-6303,906,68 )
        this.layer1[410] = new Hitbox(-5093,-7197,68,911 )
        this.layer1[411] = new Hitbox(-5034,-7197,519,83 )
        this.layer1[412] = new Hitbox(-4591,-7917,76,803 )
        this.layer1[413] = new Hitbox(-4591,-7917,1590,61 )
        this.layer1[414] = new Hitbox(-1295,-6559,1425,65 )
        this.layer1[415] = new Hitbox(-1297,-6531,51,536 )
        this.layer1[416] = new Hitbox(-1953,-6053,706,59 )
        this.layer1[417] = new Hitbox(-878,-6209,1015,61 )
        this.layer1[418] = new Hitbox(-878,-6176,55,444 )
        this.layer1[419] = new Hitbox(-2868,-7042,90,529 )
        this.layer1[420] = new Hitbox(-2868,-7042,1149,72 )
        this.layer1[421] = new Hitbox(-1796,-7765,81,795 )
        this.layer1[422] = new Hitbox(-3608,-7911,82,1393 )
        this.layer1[423] = new Hitbox(-3923,-6461,82,671 )
        this.layer1[424] = new Hitbox(-3858,-5880,1101,89 )
        this.layer1[425] = new Hitbox(-2849,-5880,92,906 )
        this.layer1[426] = new Hitbox(-2785,-5058,105,414 )
        this.layer1[427] = new Hitbox(-4949,-7543,105,351 )
        this.layer1[428] = new Hitbox(-6176,-7545,1279,81 )
        this.layer1[429] = new Hitbox(-3065,-9678,61,1823 )
        this.layer1[430] = new Hitbox(-1757,-7768,1193,66 )
        this.layer1[431] = new Hitbox(-646,-8741,82,1040 )
        this.layer1[432] = new Hitbox(-646,-8741,803,104 )
        this.layer1[433] = new Hitbox(60,-9112,97,475 )
        this.layer1[434] = new Hitbox(60,-9112,2524,82 )
        this.layer1[435] = new Hitbox(2495,-9500,89,470 )
        this.layer1[436] = new Hitbox(2495,-9520,1254,78 )
        this.layer1[437] = new Hitbox(2495,-9520,1396,78 )
        this.layer1[438] = new Hitbox(3787,-10309,104,866 )
        this.layer1[439] = new Hitbox(3787,-10309,1153,101 )
        this.layer1[440] = new Hitbox(4890,-12175,108,1967 )
        this.layer1[441] = new Hitbox(-1841,-8494,1250,89 )
        this.layer1[442] = new Hitbox(-1842,-9492,120,1088 )
        this.layer1[443] = new Hitbox(-1757,-9493,1479,66 )
        this.layer1[444] = new Hitbox(-375,-9818,97,365 )
        this.layer1[445] = new Hitbox(-291,-9813,1078,85 )
        this.layer1[446] = new Hitbox(645,-10953,144,1225 )
        this.layer1[447] = new Hitbox(2171,-9370,373,71 )
        this.layer1[448] = new Hitbox(2171,-10040,94,740 )
        this.layer1[449] = new Hitbox(1479,-10040,786,84 )
        this.layer1[450] = new Hitbox(1479,-11375,118,1419 )
        this.layer1[451] = new Hitbox(-2208,-9273,388,106 )
        this.layer1[452] = new Hitbox(-2208,-10387,94,1128 )
        ...
        this.layer1[486] = new Hitbox(6024,-10667,119,1017 )
        this.layer1[487] = new Hitbox(6135,-9759,494,109 )
        this.layer1[488] = new Hitbox(6520,-9759,109,826 )
        this.layer1[489] = new Hitbox(6520,-9054,1776,121 )
        this.layer1[490] = new Hitbox(8215,-9054,83,1278 )
        this.layer1[491] = new Hitbox(7555,-7861,664,85 )
        this.layer1[492] = new Hitbox(7555,-7861,117,2123 )
        this.layer1[493] = new Hitbox(7834,-8406,109,573 )
        this.layer1[494] = new Hitbox(6864,-8406,1079,109 )
        this.layer1[495] = new Hitbox(6864,-8965,126,668 )
        this.layer1[496] = new Hitbox(7350,-10515,100,1492 )
        this.layer1[497] = new Hitbox(6280,-10515,1170,107 )
        this.layer1[498] = new Hitbox(6278,-10653,145,243 )
        this.layer1[499] = new Hitbox(6509,-11614,138,782 )
        this.layer1[500] = new Hitbox(6570,-11612,1415,113 )
        this.layer1[501] = new Hitbox(7878,-13122,106,1623 )
        this.layer1[502] = new Hitbox(4629,-13118,3284,81 )
        this.layer1[503] = new Hitbox(6257,-13074,85,441 )
        this.layer1[504] = new Hitbox(6333,-12750,904,119 )
        this.layer1[505] = new Hitbox(7144,-12750,94,1170 )
        this.layer1[506] = new Hitbox(6910,-11564,97,480 )
        this.layer1[507] = new Hitbox(6996,-11165,506,84 )
        this.layer1[508] = new Hitbox(7419,-11165,83,332 )
        this.layer1[509] = new Hitbox(8231,-10811,115,1570 )
        this.layer1[510] = new Hitbox(7955,-9346,392,104 )
        this.layer1[511] = new Hitbox(7955,-9346,92,326 )
        this.layer1[512] = new Hitbox(7592,-7163,1565,132 )
        this.layer1[513] = new Hitbox(8084,-7522,134,393 )
        this.layer1[514] = new Hitbox(8210,-7518,529,109 )
        this.layer1[515] = new Hitbox(8610,-8256,129,847 )
        this.layer1[516] = new Hitbox(8261,-8254,381,87 )
        this.layer1[517] = new Hitbox(8406,-7125,104,528 )
        this.layer1[518] = new Hitbox(7871,-6720,639,123 )
        this.layer1[519] = new Hitbox(7871,-6720,121,364 )
        this.layer1[520] = new Hitbox(7588,-6479,404,121 )
        this.layer1[521] = new Hitbox(6841,-7343,742,104 )
        this.layer1[522] = new Hitbox(6837,-7273,109,487 )
        this.layer1[523] = new Hitbox(6911,-6934,428,145 )
        this.layer1[524] = new Hitbox(7231,-6934,109,343 )
        this.layer1[525] = new Hitbox(7231,-6702,387,111 )
        this.layer1[526] = new Hitbox(7163,-12411,361,121 )
        this.layer1[527] = new Hitbox(7430,-12673,94,383 )
        this.layer1[528] = new Hitbox(7430,-12673,479,81 )
        this.layer1[529] = new Hitbox(7326,-12083,596,66 )
        this.layer1[530] = new Hitbox(7326,-12367,77,349 )
        this.layer1[531] = new Hitbox(6759,-13080,111,357 )
        this.layer1[532] = new Hitbox(6831,-11905,338,96 )
        this.layer1[533] = new Hitbox(6835,-12051,87,242 )
        this.layer1[534] = new Hitbox(5928,-12051,994,98 )
        this.layer1[535] = new Hitbox(5928,-11981,109,550 )
        this.layer1[536] = new Hitbox(5930,-11469,643,98 )
        this.layer1[537] = new Hitbox(7440,-10061,829,119 )
        this.layer1[538] = new Hitbox(9246,-10159,128,783 )
        this.layer1[539] = new Hitbox(9340,-9490,1173,117 )
        this.layer1[540] = new Hitbox(10415,-9707,100,264 )
        this.layer1[541] = new Hitbox(10415,-9707,535,106 )
        this.layer1[542] = new Hitbox(10858,-10177,92,577 )
        this.layer1[543] = new Hitbox(9926,-10166,128,345 )
        this.layer1[544] = new Hitbox(9311,-9907,743,85 )
        this.layer1[545] = new Hitbox(8287,-9635,999,111 )
        this.layer1[546] = new Hitbox(9734,-10747,121,553 )
        this.layer1[547] = new Hitbox(9817,-10747,1216,83 )
        this.layer1[548] = new Hitbox(10626,-10509,432,85 )
        this.layer1[549] = new Hitbox(10626,-10692,100,268 )
        this.layer1[550] = new Hitbox(9794,-10443,451,72 )
        this.layer1[551] = new Hitbox(10143,-10407,109,211 )
        this.layer1[552] = new Hitbox(10211,-10332,262,45 )
        this.layer1[553] = new Hitbox(10413,-10311,60,132 )
        this.layer1[554] = new Hitbox(10768,-11668,751,113 )
        this.layer1[555] = new Hitbox(10768,-12393,113,838 )
        this.layer1[556] = new Hitbox(11869,-11741,130,362 )
        this.layer1[557] = new Hitbox(11977,-11486,899,107 )
        this.layer1[558] = new Hitbox(12754,-12141,122,678 )
        this.layer1[559] = new Hitbox(12754,-12141,494,102 )
        this.layer1[560] = new Hitbox(13108,-12891,138,851 )
        this.layer1[561] = new Hitbox(12933,-12889,185,109 )
        this.layer1[562] = new Hitbox(12933,-13209,64,429 )
        this.layer1[563] = new Hitbox(12354,-13209,643,77 )
        this.layer1[564] = new Hitbox(12373,-12652,211,92 )
        this.layer1[565] = new Hitbox(12512,-12594,72,341 )
        this.layer1[566] = new Hitbox(12352,-12328,177,77 )
        this.layer1[567] = new Hitbox(11315,-12941,1011,115 )
        this.layer1[568] = new Hitbox(11315,-12864,83,518 )
        this.layer1[569] = new Hitbox(11386,-12452,502,106 )
        this.layer1[570] = new Hitbox(11792,-12452,96,692 )
        this.layer1[571] = new Hitbox(9130,-12391,1692,87 )
        this.layer1[572] = new Hitbox(10695,-14241,1141,137 )
        this.layer1[573] = new Hitbox(10689,-14136,123,1759 )
        this.layer1[574] = new Hitbox(10779,-13791,332,132 )
        this.layer1[575] = new Hitbox(11028,-13950,83,289 )
        this.layer1[576] = new Hitbox(11028,-13950,460,43 )
        this.layer1[577] = new Hitbox(11422,-14153,66,245 )
        this.layer1[578] = new Hitbox(11030,-13967,458,60 )
        this.layer1[579] = new Hitbox(12871,-14748,130,702 )
        this.layer1[580] = new Hitbox(12992,-14137,594,96 )
        this.layer1[581] = new Hitbox(11863,-14140,395,135 )
        this.layer1[582] = new Hitbox(12177,-14401,81,396 )
        this.layer1[583] = new Hitbox(12177,-14401,464,66 )
        this.layer1[584] = new Hitbox(12556,-14346,89,132 )
        this.layer1[585] = new Hitbox(12556,-14275,351,62 )
        this.layer1[586] = new Hitbox(14988,-14225,89,660 )
        this.layer1[587] = new Hitbox(14301,-13665,776,100 )
        this.layer1[588] = new Hitbox(14301,-13665,100,978 )
        this.layer1[589] = new Hitbox(14367,-12784,1720,96 )
        this.layer1[590] = new Hitbox(15996,-13263,96,494 )
        this.layer1[591] = new Hitbox(15996,-13265,957,104 )
        this.layer1[592] = new Hitbox(15996,-13265,974,106 )
        this.layer1[593] = new Hitbox(16866,-14401,104,1242 )
        this.layer1[594] = new Hitbox(16866,-14407,487,109 )
        this.layer1[595] = new Hitbox(17271,-14902,87,604 )
        this.layer1[596] = new Hitbox(16192,-14900,1094,85 )
        this.layer1[597] = new Hitbox(16192,-15849,112,1035 )
        this.layer1[598] = new Hitbox(15823,-15849,481,102 )
        this.layer1[599] = new Hitbox(15823,-16475,115,728 )
        this.layer1[600] = new Hitbox(15642,-16475,296,85 )
        this.layer1[601] = new Hitbox(15644,-16895,77,504 )
        this.layer1[602] = new Hitbox(15303,-14704,134,525 )
        this.layer1[603] = new Hitbox(14971,-14704,466,106 )
        this.layer1[604] = new Hitbox(14975,-14930,94,332 )
        this.layer1[605] = new Hitbox(14611,-14930,458,87 )
        this.layer1[606] = new Hitbox(15141,-13119,102,360 )
        this.layer1[607] = new Hitbox(14815,-13119,428,85 )
        this.layer1[608] = new Hitbox(14815,-13034,85,289 )
        this.layer1[609] = new Hitbox(15036,-13828,928,100 )
        this.layer1[610] = new Hitbox(15862,-14064,102,336 )
        this.layer1[611] = new Hitbox(15862,-14064,539,94 )
        this.layer1[612] = new Hitbox(16300,-13994,100,755 )
        this.layer1[613] = new Hitbox(15471,-12751,92,1218 )
        this.layer1[614] = new Hitbox(14759,-11613,803,81 )
        this.layer1[615] = new Hitbox(14759,-11613,111,939 )
        this.layer1[616] = new Hitbox(14570,-12752,87,658 )
        this.layer1[617] = new Hitbox(14629,-12173,426,79 )
        this.layer1[618] = new Hitbox(14978,-12173,77,600 )
        this.layer1[619] = new Hitbox(13573,-13049,787,103 )
        this.layer1[620] = new Hitbox(13571,-12990,100,437 )
        this.layer1[621] = new Hitbox(13158,-12678,513,126 )
        this.layer1[622] = new Hitbox(16056,-14344,134,296 )
        this.layer1[623] = new Hitbox(15784,-14344,407,72 )
        this.layer1[624] = new Hitbox(15784,-14548,87,277 )
        this.layer1[625] = new Hitbox(15402,-14548,468,104 )
        this.layer1[626] = new Hitbox(16965,-15461,128,591 )
        this.layer1[627] = new Hitbox(17031,-15459,1020,117 )
        this.layer1[628] = new Hitbox(17951,-16192,100,850 )
        this.layer1[629] = new Hitbox(17384,-16194,586,92 )
        this.layer1[630] = new Hitbox(17384,-16813,109,710 )
        this.layer1[631] = new Hitbox(16925,-16813,568,89 )
        this.layer1[632] = new Hitbox(16925,-17201,66,478 )
        this.layer1[633] = new Hitbox(16388,-17201,602,70 )
        this.layer1[634] = new Hitbox(16413,-16448,326,87 )
        this.layer1[635] = new Hitbox(16666,-16394,72,537 )
        this.layer1[636] = new Hitbox(16666,-15938,577,81 )
        this.layer1[637] = new Hitbox(17137,-15938,106,513 )
        this.layer1[638] = new Hitbox(15544,-12128,1140,104 )
        this.layer1[639] = new Hitbox(16588,-13195,96,1171 )
    ...
    createLayer2() {
        ...
        this.layer2[257] = new Hitbox(2229,-3647,1024,55 )
        this.layer2[258] = new Hitbox(2231,-3918,77,322 )
        this.layer2[259] = new Hitbox(432,-3913,1858,63 )
        this.layer2[260] = new Hitbox(596,-3865,83,593 )
        this.layer2[261] = new Hitbox(-210,-3341,889,68 )
        this.layer2[262] = new Hitbox(663,-3430,756,79 )
        this.layer2[263] = new Hitbox(1338,-3689,75,324 )
        this.layer2[264] = new Hitbox(1338,-3689,284,79 )
        this.layer2[265] = new Hitbox(1555,-3627,67,742 )
        this.layer2[266] = new Hitbox(2416,-3603,75,551 )
        this.layer2[267] = new Hitbox(2069,-3131,422,79 )
        this.layer2[268] = new Hitbox(2073,-3114,81,423 )
        this.layer2[269] = new Hitbox(1373,-2768,752,77 )
        this.layer2[270] = new Hitbox(429,-4863,85,998 )
        this.layer2[271] = new Hitbox(-210,-3547,89,229 )
        this.layer2[272] = new Hitbox(-823,-3547,640,74 )
        this.layer2[273] = new Hitbox(-823,-4042,83,570 )
        this.layer2[274] = new Hitbox(-1786,-4042,1045,68 )
        this.layer2[275] = new Hitbox(-1784,-4333,89,316 )
        this.layer2[276] = new Hitbox(-2676,-4333,982,99 )
        this.layer2[277] = new Hitbox(-2676,-4269,126,476 )
        this.layer2[278] = new Hitbox(-3187,-3871,637,78 )
        this.layer2[279] = new Hitbox(-3187,-4479,98,621 )
        this.layer2[280] = new Hitbox(-3940,-4479,851,102 )
        this.layer2[281] = new Hitbox(-2310,-5011,96,720 )
        this.layer2[282] = new Hitbox(-2225,-5011,715,84 )
        this.layer2[283] = new Hitbox(-2069,-4281,117,1340 )
        this.layer2[284] = new Hitbox(-2246,-4615,1369,102 )
        this.layer2[285] = new Hitbox(-990,-5296,107,784 )
        this.layer2[286] = new Hitbox(-1613,-6204,101,1277 )
        this.layer2[287] = new Hitbox(-1613,-6204,613,106 )
        this.layer2[288] = new Hitbox(-1098,-6122,99,559 )
        this.layer2[289] = new Hitbox(-1098,-5695,1358,132 )
        this.layer2[290] = new Hitbox(159,-7456,101,1767 )
        this.layer2[291] = new Hitbox(-947,-5296,759,75 )
        this.layer2[292] = new Hitbox(-272,-5263,85,280 )
        this.layer2[293] = new Hitbox(-272,-5057,2441,74 )
        this.layer2[294] = new Hitbox(161,-4865,294,73 )
        this.layer2[295] = new Hitbox(161,-5006,68,214 )
        this.layer2[296] = new Hitbox(192,-5953,1164,100 )
        this.layer2[297] = new Hitbox(1244,-6291,113,437 )
        this.layer2[298] = new Hitbox(1244,-6291,707,85 )
        this.layer2[299] = new Hitbox(1839,-6225,118,280 )
        this.layer2[300] = new Hitbox(1839,-6034,880,90 )
        this.layer2[301] = new Hitbox(2606,-6814,112,794 )
        this.layer2[302] = new Hitbox(2606,-6814,1035,87 )
        this.layer2[303] = new Hitbox(3554,-8240,87,1513 )
        this.layer2[304] = new Hitbox(2268,-5954,80,970 )
        this.layer2[305] = new Hitbox(2080,-5061,268,78 )
        this.layer2[306] = new Hitbox(1462,-7391,122,1140 )
        this.layer2[307] = new Hitbox(-1283,-6417,1456,120 )
        this.layer2[308] = new Hitbox(-1281,-6330,134,153 )
        this.layer2[309] = new Hitbox(3265,-6774,81,359 )
        this.layer2[310] = new Hitbox(3339,-6518,1227,103 )
        this.layer2[311] = new Hitbox(4460,-7411,106,914 )
        this.layer2[312] = new Hitbox(4460,-7413,468,104 )
        this.layer2[313] = new Hitbox(4834,-7811,94,503 )
        this.layer2[314] = new Hitbox(4834,-7819,1151,115 )
        this.layer2[315] = new Hitbox(5904,-8747,85,1043 )
        this.layer2[316] = new Hitbox(4712,-8747,1208,67 )
        this.layer2[317] = new Hitbox(4718,-8714,70,367 )
        this.layer2[318] = new Hitbox(3438,-8413,1350,66 )
        this.layer2[319] = new Hitbox(5362,-8144,98,398 )
        this.layer2[320] = new Hitbox(4520,-8144,940,51 )
        this.layer2[321] = new Hitbox(4520,-8363,92,272 )
        this.layer2[322] = new Hitbox(4212,-6476,106,860 )
        this.layer2[323] = new Hitbox(4308,-5739,849,126 )
        this.layer2[324] = new Hitbox(5034,-6020,126,304 )
        this.layer2[325] = new Hitbox(5034,-6020,1100,138 )
        this.layer2[326] = new Hitbox(6041,-5903,96,902 )
        this.layer2[327] = new Hitbox(5715,-5094,343,94 )
        this.layer2[328] = new Hitbox(5715,-5094,119,774 )
        this.layer2[329] = new Hitbox(5296,-4407,539,87 )
        this.layer2[330] = new Hitbox(5296,-4407,92,953 )
        this.layer2[331] = new Hitbox(4962,-4730,815,87 )
        this.layer2[332] = new Hitbox(4962,-5671,90,965 )
        this.layer2[333] = new Hitbox(5442,-5943,123,372 )
        this.layer2[334] = new Hitbox(5520,-5643,315,72 )
        this.layer2[335] = new Hitbox(5761,-5758,75,132 )
        this.layer2[336] = new Hitbox(5761,-5758,164,77 )
        this.layer2[337] = new Hitbox(5887,-5690,38,66 )
        this.layer2[338] = new Hitbox(5887,-5671,181,47 )
        this.layer2[339] = new Hitbox(4519,-6690,981,152 )
        this.layer2[340] = new Hitbox(5374,-7203,126,665 )
        this.layer2[341] = new Hitbox(5374,-7203,846,85 )
        this.layer2[342] = new Hitbox(6140,-7137,79,836 )
        this.layer2[343] = new Hitbox(6140,-6384,270,83 )
        this.layer2[344] = new Hitbox(6330,-6384,81,560 )
        this.layer2[345] = new Hitbox(6081,-5925,251,100 )
        this.layer2[346] = new Hitbox(6184,-6843,1019,104 )
        this.layer2[347] = new Hitbox(7101,-6756,104,395 )
        this.layer2[348] = new Hitbox(7101,-6448,634,87 )
        this.layer2[349] = new Hitbox(7650,-7218,87,778 )
        this.layer2[350] = new Hitbox(7650,-7218,624,106 )
        this.layer2[351] = new Hitbox(8188,-8323,86,1212 )
        this.layer2[352] = new Hitbox(8188,-8323,466,89 )
        this.layer2[353] = new Hitbox(8565,-8971,90,737 )
        this.layer2[354] = new Hitbox(8565,-8971,1866,111 )
        this.layer2[355] = new Hitbox(10295,-9725,138,861 )
        this.layer2[356] = new Hitbox(10363,-9727,764,102 )
        this.layer2[357] = new Hitbox(7701,-6773,1150,115 )
        this.layer2[358] = new Hitbox(8763,-7320,87,661 )
        this.layer2[359] = new Hitbox(8763,-7320,449,77 )
        this.layer2[360] = new Hitbox(9144,-8099,64,849 )
        this.layer2[361] = new Hitbox(8209,-8103,941,85 )
        this.layer2[362] = new Hitbox(8629,-8616,547,81 )
        this.layer2[363] = new Hitbox(9095,-8941,81,407 )
        this.layer2[364] = new Hitbox(8694,-9552,96,614 )
        this.layer2[365] = new Hitbox(8760,-9551,804,98 )
        this.layer2[366] = new Hitbox(9469,-9911,93,456 )
        this.layer2[367] = new Hitbox(9469,-9911,565,79 )
        this.layer2[368] = new Hitbox(9942,-9856,92,931 )
        this.layer2[369] = new Hitbox(9766,-10441,88,542 )
        this.layer2[370] = new Hitbox(9835,-10437,773,96 )
        this.layer2[371] = new Hitbox(10507,-10905,100,564 )
        this.layer2[372] = new Hitbox(10507,-10906,970,89 )
        this.layer2[373] = new Hitbox(11390,-10893,87,936 )
        this.layer2[374] = new Hitbox(10859,-10037,590,79 )
        this.layer2[375] = new Hitbox(10864,-9975,81,354 )
        this.layer2[376] = new Hitbox(10930,-9695,1348,74 )
        this.layer2[377] = new Hitbox(12171,-10287,105,609 )
        this.layer2[378] = new Hitbox(12171,-10287,686,81 )
        this.layer2[379] = new Hitbox(12757,-11607,100,1401 )
        this.layer2[380] = new Hitbox(11099,-9725,1103,62 )
        this.layer2[381] = new Hitbox(11192,-9658,124,798 )
        this.layer2[382] = new Hitbox(11267,-8943,745,85 )
        this.layer2[383] = new Hitbox(11899,-8943,113,874 )
        this.layer2[384] = new Hitbox(10830,-8194,1075,123 )
        this.layer2[385] = new Hitbox(10830,-8194,100,479 )
        this.layer2[386] = new Hitbox(9840,-7807,1090,91 )
        this.layer2[387] = new Hitbox(9838,-8529,108,748 )
        this.layer2[388] = new Hitbox(9924,-8529,287,85 )
        this.layer2[389] = new Hitbox(10118,-8944,94,500 )
